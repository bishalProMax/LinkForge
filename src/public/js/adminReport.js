...
const ALL_EVENTS = [
  ...
  "SIGNUP_SUCCESS", "SIGNUP_CAPTCHA_FAILED", "SIGNUP_EMAIL_EXISTS", "SIGNUP_RESEND_LIMIT_REACHED", "SIGNUP_COOLDOWN_ACTIVE", "SIGNUP_LOCAL_AUTH_LINKED", "LOCAL_AUTH_REQUIRED", "OTP_REQUESTED", "OTP_COOLDOWN_ACTIVE", "OTP_LIMIT_REACHED", "INVALID_OTP", "OTP_EXPIRED", "OTP_TOO_MANY_ATTEMPTS", "OTP_VERIFIED",
  "PASSWORD_RESET_SESSION_EXPIRED", "PASSWORD_RESET_SAME_PASSWORD", "PASSWORD_RESET_SUCCESS", "PASSWORD_RESET_BLOCKED_BANNED",
  "RATE_LIMIT_EXCEEDED", "USER_BANNED", "USER_UNBANNED", "PROFILE_USERNAME_CHANGED", "PROFILE_PASSWORD_CHANGED","ACCOUNT_DELETION_REQUESTED", "ACCOUNT_DELETION_CANCELLED",
];
